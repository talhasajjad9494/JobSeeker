...
public class Helper {
    ...
    public static void createInstance() throws IOException {
        String url = Utility.getValue("Launch", "StageWebsite");
    ...
    public static void selectCV(WebElement elementOptions) {
        // Global function for selecting CV
        selectObj = new Select(elementOptions);
        List<WebElement> listOfElements = selectObj.getOptions();
        try {
            if (!listOfElements.isEmpty()) {
