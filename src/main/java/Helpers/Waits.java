...
public class Waits {
    ...
    public static void fluentWaitForTextAppearance(WebDriver driver, WebElement element, int timeout , int timeIntervalInMillis) {
        waitForElementUntilVisibility(driver, element, timeout);
        fluentWait = new FluentWait<>(driver)
                .withTimeout(Duration.ofSeconds(timeout))
                .pollingEvery(Duration.ofMillis(timeIntervalInMillis))
